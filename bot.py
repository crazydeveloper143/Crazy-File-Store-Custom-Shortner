...
async def main(bot: Client, message: Message):
    if message.chat.type == enums.ChatType.PRIVATE:
        ...
        keyboard = InlineKeyboardMarkup([
            [InlineKeyboardButton("Start New Bot", url="https://t.me/FileSharev3Bot")]
        ])

        await message.reply_text(
            text="**इस बॉट में कॉपीराइट आ गया है इसकी जगह दूसरा बॉट स्टार्ट किया गया है अब उसका उपयोग करें आपकी जो पुरानी फाइलें स्थायी लिंक के साथ बनी हैं वो डिलीट नहीं होंगी |\n\nThis bot has been copyrighted, another bot has been started in its place, now use it. Your old files created with permanent links will not be deleted.\n\nNew Bot Link :\n\nt.me/FileSharev3Bot\nt.me/FileSharev3Bot**",
            disable_web_page_preview=True,
